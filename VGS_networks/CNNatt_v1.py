# DAVEnet cross_atten with connection size 128*14*14
...
modeldir = machine_path +  '/'
datadir = machine_path +  'features/.../'
...
pool2 = MaxPooling1D(1,strides = 1, padding='same')(bn2)

# layer 3
forward3 = Conv1D(512,17,padding="same",activation=activation_C,name = 'conv3')(pool2)
...
weightAD = Dense(128,activation='sigmoid')(scoreA)
...
if use_pretrained:
    ...
    allavRecalls = numpy.ndarray.tolist(allavRecalls)
...
filename = machine_path + 'features/.../valY_ch0'
infile = open(filename,'rb')
Y_val = pickle.load(infile)
infile.close()

#........................................... loading validation data (logmels)
filename = machine_path + 'features/.../valX3_ch0'
infile = open(filename ,'rb')
