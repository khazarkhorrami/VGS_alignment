...
scipy.io.savemat(path_out + 'sub_times.mat' , { 'all_time_masks':all_time_masks ,'word_sim_on':word_sim_on,'word_sim_off':word_sim_off}) 
    ...
    if len(subinds): 
        ...
        for counter_label in range(len(subnouns)): # loop over WI items
            ...
            if label_caption in ref_names: # first detect TP 
                ...
                all_tensors_GT.append(tensor_GT )
