...
###############################################################################
# this file first loads test data nouns and selects corrected ones based on spellcheck applied in previous step 
# next it compares the test caption words with the corresponding image object labels using word2vec similarity function
# the caption words that are similar to image object labels based on a defined similarity threshold are selected and saved
###############################################################################
