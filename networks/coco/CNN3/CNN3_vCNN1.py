# CNN1, MISA with layer normalization, m = 0.1, self attention added
graph_title  = 'CNN1 model with self attention and m = 0.1'
...
# layer 1: 45 ms 
f0 = Conv1D(128,3,padding="same",activation=activation_C,name='layer1')(audio_sequence)       # conv 1
...
#layer 7: 285 ms
f4 = Conv1D(256,3,padding="same",activation=activation_C,name='layer7')(pool1)                # conv 5
...
pool2 = MaxPooling1D(3,strides = 2,padding='same')(concat1) # 64,512
###############################################################################

#layer 9: 785 ms
f5 = Conv1D(256,5,padding="same",activation=activation_C,name='layer9')(pool2)  # conv 6
d5 = Dropout(dropout_size)(f5) # 64,512
#out_audio_channel = BatchNormalization(axis=-1,name = 'bn_audio')(d5)
...
out_audio_channel = BatchNormalization(axis=-1,name = 'bn_audio')(concat2)
...
reshape_visual_channel = Reshape([196,256],name='reshape_visual')(bn_visual)
