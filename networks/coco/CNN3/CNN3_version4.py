...
modeldir = machine_path +  'project2/current/outputs/models/coco/CNN3/v4/'
...
# layer 2
#165 ms
forward2 = Conv1D(128,11,padding="same",activation=activation_C,name = 'conv2')(dr1)
...
pool3 = MaxPooling1D(3,strides = 2,padding='same')(concat1)
###############################################################################
...
pool4 = MaxPooling1D(3,strides = 2,padding='same')(concat2)
###############################################################################
