...
modeldir = machine_path +  'project2/current/outputs/models/coco/CNN0/v0/'
...
def custom_layer(tensor):
    ...
    sisa = Reshape([1],name='reshape_sisa')(sisa)
    return sisa
...
new_audio_model.layers[19].set_weights(model.layers[25].get_weights()) 
new_audio_model.layers[20].set_weights(model.layers[27].get_weights()) # out audio
...
new_visual_model.layers[5].set_weights(model.layers[24].get_weights()) 
new_visual_model.layers[6].set_weights(model.layers[26].get_weights())# out visual
