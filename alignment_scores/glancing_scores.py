...
# 1. object detection glancing (how well the model can locate the object within image in a given time window )
# 2. word detection glancing (how well the model can locate the word within spoken utterance at given object mask)
