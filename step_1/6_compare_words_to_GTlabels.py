...
# and then selects corrected ones based on spellcheck applied in step 3
...
path_in_nouns = '/worktmp/hxkhkh/project_3/outputs/step_1/2/'
file_in_nouns = 'noun_data.mat'

path_in_spellcheck = '/worktmp/hxkhkh/project_3/outputs/step_1/3/'
file_in_spellcheck = 'corrected_nouns_index.mat'

path_in_labels = '/worktmp/hxkhkh/project_3/outputs/step_1/4/'
file_in_labels = 'unified_labels.mat'

path_out = '/worktmp/hxkhkh/project_3/outputs/step_1/6/'
