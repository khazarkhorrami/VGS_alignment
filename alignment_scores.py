...
path_in_AVtensor = os.path.join(path_project ,'outputs/step_5/hidden/')
...
path_out = '/worktmp/hxkhkh/project3/outputs/step_2/'
file_out = 'alignments' + file_in_AVtensor 
#.............................................................................. input parameters
...
data = scipy.io.loadmat(path_in_processed_nouns + file_in_processed_nouns, variable_names = ['all_accpted_words','all_accepted_ind'])
...
data = scipy.io.loadmat(path_in_processes_time + file_in_processes_time , variable_names = ['wavfile_nouns_onsets_sim','wavfile_nouns_offset_sim','all_time_masks'])

all_onsets = data ['wavfile_nouns_onsets_sim'][0]
all_offsets = data ['wavfile_nouns_offset_sim'][0]
    ...
    if len(subinds): 
        ...
        for counter_label in range(len(subinds)): 
            ...
            if subnoun in ref_names: 
                ...
                #..............................................................................  Spatial Alignment
                t_onset = t_onsets_image[counter_label]
                t_offset = t_offsets_image[counter_label]
                t_duration = t_offset- t_onset
                
                score_sa, area_GT , col = compute_spatial_alignment (t_onset, t_offset,tensor_in_sa, imageID)
                
                #.............................................................................. Temporal Alignment
                t_onset = numpy.maximum (t_onsets_image[counter_label] - 50 , 0 )
                t_offset = numpy.minimum (t_offsets_image[counter_label]+ 50 , 512)
...
scipy.io.savemat(path_out + file_out , {'all_sa_scores':all_sa_scores, 'all_ta_scores':all_ta_scores, 'all_meta_info':all_meta_info})                
