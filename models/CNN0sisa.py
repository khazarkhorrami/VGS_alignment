...
def build_vgsmodel (X_shape, Y_shape , modeldir):
    ...
    embedding_audio = Lambda(lambda  x: K.l2_normalize(x,axis=-1),name='out_audio')(out_audio)
    embedding_visual = Lambda(lambda  x: K.l2_normalize(x,axis=-1),name='out_visual')(out_visual)
